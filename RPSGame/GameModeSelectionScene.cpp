...
//"DisplayGameModeSelectionScene" displays the options for available game modes, and then passes off an input request to "RequestInput."
//"RequestInput" interprets console input and assigns an appropriate game type state.
